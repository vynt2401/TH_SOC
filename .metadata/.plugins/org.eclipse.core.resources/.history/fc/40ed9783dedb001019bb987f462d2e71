...
int main() {
    ...
    while(1) {
        ...
        if (fault) {
            printf("Sensor Fault! Resetting config...\n");
            max31865_write(MAX31865_CONFIG_REG, 0xC2);
        }
